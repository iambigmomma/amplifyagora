...
const onNewMarket = (preQuery, newData) =>{
    ...
    >
    {
      ...
      return (
        ...
        { searchResults.length >0 ? (
          ...
          <h2 className="header">
            <img src="https://icon.now.sh/store_mall_directory/527FFF" alt="Store Icon"
                ...
                >
                  <div>
                    <span className="flex">
                      ...
                      <img src="https://icon.now.sh/shopping_cart/f6-" alt="Shopping Cart" />>
                    </span>  
